...
def service_instance():
    return factories.ServiceInstanceFactory.create(
        id="1234",
...
def subtest_deprovision_removes_ALIAS_record(tasks, service_instance, route53):
...
def test_deprovision_happy_path(
    ...
    subtest_deprovision_removes_ALIAS_record(tasks, service_instance, route53)
