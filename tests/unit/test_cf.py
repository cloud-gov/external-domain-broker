...
def test_gets_org_name(
    organization_guid, access_token, cf_api_client, request_mocker_with_auth_mock
):
    ...
    assert cf_api_client.get_organization_name_by_guid(organization_guid) == "org-1234"
